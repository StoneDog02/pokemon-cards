...
async function getCards() {
  ...
  const response = await fetch(
    "https://graphql.contentful.com/content/v1/spaces/yr7ioi9ceyks/environments/master?access_token=6ZtAZe2ZBgS3jNmxGgaBWU241qFvtWnk_jAy488xgd0&query=" +
      query
  );
...
export const loader: LoaderFunction = async () => {
  ...
  return json({
    ...
    //     pokemonDescLow: "It may cause floods and tsunamis.",
    //   },
    //   {
    //     stage: "BASIC",
    //     name: "Herbuito",
...
export default function Index() {
  ...
  return (
    <div>
      {cards.map((card, idx) => (
        <Card card={card} id={idx} key={idx}></Card>
      ))}
